...
<button type="button" class="admin-theme-toggle" data-theme-toggle aria-label="切换后台主题">主题切换</button>
...
(function(){{
  try {{
    var stored = localStorage.getItem("wifiportal_admin_theme");
    document.documentElement.setAttribute("data-admin-theme", stored || "void");
  }} catch (error) {{
    document.documentElement.setAttribute("data-admin-theme", "void");
  }}
}})();
</script>
<style>
...
/* ADMIN_THEME_VOID_MINIMAL_V1 */
html[data-admin-theme="void"] {{
  --void-bg:rgb(10,10,10);
  --void-panel:rgba(19,22,27,.72);
  --void-panel-solid:#111419;
  --void-line:rgba(148,163,184,.16);
  --void-line-strong:rgba(125,211,252,.26);
  --void-text:#f8fafc;
  --void-muted:#98a2b3;
  --void-soft:#cbd5e1;
  --void-blue:#4ea8ff;
  --void-green:#6ee7b7;
  --void-red:#fb7185;
  --void-shadow:0 28px 80px rgba(0,0,0,.48);
  color-scheme:dark;
}}

html[data-admin-theme="void"] body {{
  font-family:Bahnschrift,"Segoe UI Variable","Segoe UI",Arial,sans-serif !important;
  background:
    linear-gradient(115deg,rgba(78,168,255,.11),transparent 28%),
    linear-gradient(180deg,rgb(10,10,10),#0d0f12 46%,#090909) !important;
  color:var(--void-text) !important;
  letter-spacing:0 !important;
}}

html[data-admin-theme="void"] body:before {{
  content:"";
  position:fixed;
  inset:0;
  pointer-events:none;
...
html[data-admin-theme="void"] .wrap {{
  position:relative !important;
  z-index:1 !important;
...
html[data-admin-theme="void"] .nav {{
  position:sticky !important;
  top:0 !important;
...
html[data-admin-theme="void"] .nav:before {{
  content:"WiFi Portal / Operations Console" !important;
  color:var(--void-text) !important;
  font-size:21px !important;
  font-weight:900 !important;
  letter-spacing:0 !important;
  margin:0 0 14px 2px !important;
  text-shadow:0 0 24px rgba(78,168,255,.25) !important;
}}

html[data-admin-theme="void"] .nav a,
html[data-admin-theme="void"] .admin-theme-toggle {{
  color:var(--void-soft) !important;
...
html[data-admin-theme="void"] .nav a:hover,
html[data-admin-theme="void"] .admin-theme-toggle:hover {{
  color:#ffffff !important;
  background:rgba(78,168,255,.11) !important;
  box-shadow:inset 0 -1px 0 rgba(78,168,255,.38),0 0 24px rgba(78,168,255,.12) !important;
}}
...
html[data-admin-theme="void"] .card {{
  background:linear-gradient(180deg,rgba(20,23,29,.78),rgba(13,15,18,.72)) !important;
  border:1px solid var(--void-line) !important;
  border-radius:8px !important;
  box-shadow:var(--void-shadow),inset 0 1px 0 rgba(255,255,255,.05) !important;
  padding:22px !important;
...
html[data-admin-theme="void"] .card h1,
html[data-admin-theme="void"] .card h2 {{
  color:#ffffff !important;
  letter-spacing:0 !important;
  text-shadow:0 0 28px rgba(78,168,255,.16) !important;
}}
...
html[data-admin-theme="void"] .muted,
html[data-admin-theme="void"] p {{
  color:var(--void-muted) !important;
}}

html[data-admin-theme="void"] .grid {{
  gap:16px !important;
}}

html[data-admin-theme="void"] .stat {{
...
html[data-admin-theme="void"] .stat b {{
  color:#ffffff !important;
  letter-spacing:0 !important;
}}

html[data-admin-theme="void"] input,
html[data-admin-theme="void"] textarea,
html[data-admin-theme="void"] select {{
...
html[data-admin-theme="void"] input:focus,
html[data-admin-theme="void"] textarea:focus,
html[data-admin-theme="void"] select:focus {{
  border-color:var(--void-blue) !important;
  box-shadow:0 0 0 3px rgba(78,168,255,.13),0 0 24px rgba(78,168,255,.16) !important;
}}

html[data-admin-theme="void"] button,
html[data-admin-theme="void"] .btn {{
  background:linear-gradient(180deg,rgba(78,168,255,.96),rgba(35,95,167,.92)) !important;
  color:#ffffff !important;
  border:0 !important;
  border-radius:5px !important;
  box-shadow:0 10px 28px rgba(78,168,255,.2),inset 0 1px 0 rgba(255,255,255,.22) !important;
  font-weight:800 !important;
}}

html[data-admin-theme="void"] .danger {{
  background:linear-gradient(180deg,#fb7185,#be123c) !important;
  box-shadow:0 10px 28px rgba(251,113,133,.18) !important;
}}

html[data-admin-theme="void"] .ok {{
  color:var(--void-green) !important;
}}

html[data-admin-theme="void"] .bad {{
  color:var(--void-red) !important;
}}

html[data-admin-theme="void"] table {{
...
html[data-admin-theme="void"] th {{
  background:rgba(255,255,255,.045) !important;
  color:var(--void-soft) !important;
  border-bottom:1px solid var(--void-line-strong) !important;
}}

html[data-admin-theme="void"] td,
html[data-admin-theme="void"] th {{
  border-bottom:1px solid rgba(148,163,184,.12) !important;
  color:var(--void-soft) !important;
}}

html[data-admin-theme="void"] tr:hover td {{
  background:rgba(78,168,255,.06) !important;
}}

html[data-admin-theme="void"] code,
html[data-admin-theme="void"] pre {{
  background:rgba(255,255,255,.06) !important;
  color:#dbeafe !important;
  border:1px solid rgba(78,168,255,.16) !important;
}}

html[data-admin-theme="void"] .voucher-status-badge,
html[data-admin-theme="void"] .dense-filter-btn,
html[data-admin-theme="void"] .device-filter-btn {{
  border-radius:4px !important;
}}
...
(function(){{
  function applyTheme(theme) {{
    ...
    try {{ localStorage.setItem("wifiportal_admin_theme", theme); }} catch (error) {{}}
    var label = theme === "void" ? "主题：暗黑" : "主题：亮色";
    document.querySelectorAll("[data-theme-toggle]").forEach(function(button) {{
      button.textContent = label;
      button.setAttribute("aria-label", "切换后台主题，当前" + (theme === "void" ? "暗黑" : "亮色"));
    }});
  }}
  var current = document.documentElement.getAttribute("data-admin-theme") || "void";
  applyTheme(current);
  document.addEventListener("click", function(event) {{
    var button = event.target.closest("[data-theme-toggle]");
    if (!button) return;
    var next = document.documentElement.getAttribute("data-admin-theme") === "void" ? "light" : "void";
    applyTheme(next);
  }});
}})();
</script>
